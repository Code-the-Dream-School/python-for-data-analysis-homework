...
Once you have created the pull request, include a link for the pull request in your homework submission.  Your reviewer will be notified, and will approve your request or ask for rework.  **Do not merge your pull request until it has been approved.**

Good luck with the class!

## Resources:

* [Link to curriculum repo](https://github.com/Code-the-Dream-School/python-for-data-analysis-v3)
